...
// 1. Создать функционал с функцией for или for...of 
// 1.1 создать prompt с записью 'ввести число'
// 1.2 создать функцию alert 'Было введено не число, попробуйте еще раз'
// 1.3 посчитать сумму элементов массива и записать ее в переменную total
// 1.4 после вывести строку 'Общая сумма чисел равна [сумма]'
